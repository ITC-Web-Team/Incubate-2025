    ...
    <section className="py-16 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 digital-noise">
      <div className="container mx-auto px-4">
        ...
        <div className="relative w-full mb-16 overflow-hidden border border-blue-300/30 dark:border-blue-500/30 rounded-xl p-6 shadow-glow bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
          ...
          >
            {/* ECG baseline */}
            <line x1="0" y1="50" x2="1000" y2="50" stroke="#4f46e5" strokeWidth="1" strokeDasharray="5,5" />
            ...
            {timelineData.map((item, index) => (
              ...
              >
                ...
                <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-lg p-5 shadow-lg hover:shadow-glow transition-all duration-300 border border-blue-200 dark:border-blue-900">
                  <h4 className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 text-lg">{item.date}</h4>
                  <p className="text-sm font-medium dark:text-white mt-2">{item.title}</p>
                  {item.description && (
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden opacity-10">
            <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
              ...
              <path d="M10,30 L90,30" fill="none" stroke="#4f46e5" strokeWidth="0.2" strokeDasharray="1,3" />
              <path d="M10,70 L90,70" fill="none" stroke="#4f46e5" strokeWidth="0.2" strokeDasharray="1,3" />
              <path d="M30,10 L30,90" fill="none" stroke="#4f46e5" strokeWidth="0.2" strokeDasharray="1,3" />
              <path d="M70,10 L70,90" fill="none" stroke="#4f46e5" strokeWidth="0.2" strokeDasharray="1,3" />
            </svg>
          </div>
        </div>
      </div>
